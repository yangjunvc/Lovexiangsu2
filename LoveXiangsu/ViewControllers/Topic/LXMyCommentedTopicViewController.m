//
//  LXMyCommentedTopicViewController.m
//  LoveXiangsu
//
...
static NSString *topicCellIdentifier = @"MyCommentedTopicCell";

@interface LXMyCommentedTopicViewController ()

@property (strong, nonatomic) UIView *emptyView;

@end

@implementation LXMyCommentedTopicViewController
...
- (void)putNavigationBar
{
    ...
    [self.lxTitleLabel setTitle:@"我回复过的帖子" forState:UIControlStateNormal];
...
-(void)asyncConnectGetMyTopicList{
    ...
    LXMyCommentedTopicRequest * request = [[LXMyCommentedTopicRequest alloc]init];//初始化网络请求
