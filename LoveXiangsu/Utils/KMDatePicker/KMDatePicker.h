...
typedef NS_ENUM(NSUInteger, KMDatePickerStyle) {
    ...
    KMDatePickerStyleYearMonthDayHourMinuteSecond,
    KMDatePickerStyleHourMinuteSecond,
    KMDatePickerStyleMonthDay,
};
...
@property (strong, nonatomic) NSDate *greatThanMinDate;

@property (strong, nonatomic) NSDate *maxLimitedDate; //最大限制时间；默认值为2060-12-31 23:59
@property (strong, nonatomic) NSDate *lessThanMaxDate;
