...
@interface LXMessageToolBar()<UITextViewDelegate, DXFaceDelegate>
{
...
@implementation LXMessageToolBar
...
- (void)setupSubviews
{
    ...
    //表情
    self.faceButton = [[UIButton alloc] initWithFrame:CGRectMake(kHorizontalPadding, kVerticalPadding, kInputTextViewMinHeight, kInputTextViewMinHeight)];
...
//    allButtonWidth += CGRectGetWidth(self.faceButton.frame) + kHorizontalPadding * 1.5;
    allButtonWidth += CGRectGetMaxX(self.faceButton.frame);
    textViewLeftMargin += CGRectGetMaxX(self.faceButton.frame);
...
//    allButtonWidth += CGRectGetWidth(self.moreButton.frame) + kHorizontalPadding * 2.5;
    ...
    self.sendButton.frame = CGRectMake(CGRectGetWidth(self.bounds) - kHorizontalPadding - kInputTextViewMinHeight - 15, kVerticalPadding, kInputTextViewMinHeight + 15, kInputTextViewMinHeight);
//    self.sendButton = [[UIButton alloc] initWithFrame:CGRectMake(CGRectGetWidth(self.bounds) - kHorizontalPadding - kInputTextViewMinHeight, kVerticalPadding, kInputTextViewMinHeight, kInputTextViewMinHeight)];
    ...
    [self.sendButton setTitleColor:LX_SECOND_TEXT_COLOR forState:UIControlStateNormal];
    [self.sendButton setTitle:@"发送" forState:UIControlStateNormal];
    [self.sendButton setTitleColor:LX_SECOND_TEXT_COLOR forState:UIControlStateHighlighted];
    [self.sendButton setTitle:@"发送" forState:UIControlStateHighlighted];
    [self.sendButton setTitleColor:LX_SECOND_TEXT_COLOR forState:UIControlStateSelected];
    [self.sendButton setTitle:@"发送" forState:UIControlStateSelected];
...
//    _inputTextView.placeHolder = NSLocalizedString(@"message.toolBar.inputPlaceHolder", @"input a new message");
    _inputTextView.placeHolder = @"回复帖子";
