...
@protocol LXMessageToolBarDelegate;
@interface LXMessageToolBar : UIView

@property (nonatomic, weak) id <LXMessageToolBarDelegate> delegate;
...
@protocol LXMessageToolBarDelegate <NSObject>
