//
//  LXArticleListByStoreIdRequest.m
//  LoveXiangsu
//
...
@implementation LXArticleListByStoreIdRequest

-(id)init{
    self = [super init];
    if (self) {
        self.baseUrl    = HTTP_BASEURL;
        self.requestUrl = REQUESTURL_GOODSLISTBYID;
    }
    return self;
}
...
-(void)handleResponse:(LXBaseRequest*)request{
    ...
    if (!headerError) {
        ...
        for (int i=0; i<contentArray.count;i++) {
            ...
            LXArticleInfoResponseModel * contentmodel = [LXArticleInfoResponseModel objectFromDictionary:contentItemDic];
